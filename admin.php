...
<?php
$stmtCate = $db->prepare("SELECT * FROM users ORDER BY id ASC");
$stmtCate->execute();
...
<div class="container" style="padding: 40px 20px; max-width: 1300px; margin: 0 auto;">
    ...
    <h1 style="text-align:center; font-size:42px; color:#2b5876; margin:30px 0;">
     ...
     <div class="card shadow mt-4">
            <div class="card-body">
                <a href="add_user_admin.php" class="btn add-admin-btn mb-3">
                    + Add User Admin
                </a>
                    ...
                    <?php if (!empty($listCate)): ?>
                        <?php foreach ($listCate as $c): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($c['date_created']) ?></td>
                                <td><?= htmlspecialchars($c['date_expires']) ?></td>
                                <td><?= htmlspecialchars($c['date_modified']) ?></td>
                                <td class="admin-actions">
                                    <a href="edit_admin.php?id=<?= $c['id'] ?>" class="btn btn-primary btn-sm">Edit</a>
                                    <a href="delete_admin.php?id=<?= $c['id'] ?>" 
